...
public class JWTAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
	...
	/*
	 * public JWTAuthenticationFilter(AuthenticationFailureHandler
	 * failureHandler, RequestMatcher requiresAuthenticationRequestMatcher,
	 * JWTTokenService jwtTokenService) {
	 * super(requiresAuthenticationRequestMatcher); this.jwtTokenService =
	 * jwtTokenService; this.failureHandler = failureHandler; }
	 */
